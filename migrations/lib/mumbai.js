...
const deploy_mumbai = async (web3, deployer, accounts, specialAccounts) => {
  let network = 'mumbai'
  ...
  wethInfo = {
    name: 'WETH',
    imple: '0xA6FA4fB5f76172d178d61B04b0ecd319C5d1C0aa'
  }
  totalRet = syncDeployInfo(network, 'WBNB', wethInfo, totalRet)

  factoryInfo = {
    name: 'PancakeFactory',
    imple: '0x1F98431c8aD98523631AE4a59f267346ea31F984'
  }
  totalRet = syncDeployInfo(network, 'PancakeFactory', factoryInfo, totalRet)

  routerInfo = {
    name: 'PancakeRouter',
    imple: '0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45'
  }
